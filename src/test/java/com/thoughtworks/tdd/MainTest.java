...
public class MainTest {
    ...
    public void should_print_please_input_carNum_when_call_showParkPage_given_not_parking_lots_not_full(){
        ...
        GoToParkingController goToPark = new GoToParkingController(request,response,parkingBoy);
        goToPark.process();
    ...
    public void should_print_park_successfully_and_receipt_when_call_park(){
        ...
        ParkingController parking = new ParkingController(request,response,parkingBoy);
        parking.process();
    ...
    public void should_print_car_has_been_token_successfully_and_carNum_when_call_unpark_given_right_receipt(){
        ...
        PickUpController pickUp = new PickUpController(request,response,parkingBoy);
        pickUp.process();
